...
- React/Tauri shell 脚手架，包含 provider profile 管理、provider health/capability summary 和 Agent 状态面板。
...
- 扩展 Agent template studio，加入 prompt CRUD、变量、版本历史和 provider/model 校验。
