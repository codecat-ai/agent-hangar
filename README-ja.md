...
- guided source-checkout operator walkthrough と周辺の provider/template/execution panel について、accessibility、keyboard flow、named region、onboarding note を強化する。
