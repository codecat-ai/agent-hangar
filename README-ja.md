...
- provider profile、template validation、demo scenario、execution evidence、collaboration triage、workspace portability、import/export dry run を、1 つの guided source-checkout operator walkthrough へつなげる。
...
- cadence を上げたり desktop package release を準備したりする前に、accessibility と onboarding を改善する。
